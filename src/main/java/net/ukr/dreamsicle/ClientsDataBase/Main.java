package net.ukr.dreamsicle.ClientsDataBase;
...
public class Main {
    static final String DB_CONNECTION = "jdbc:mysql://localhost:3306/dream";
    static final String DB_USER = "root";
    static final String DB_PASSWORD = "YURAdreamsicle12345";
